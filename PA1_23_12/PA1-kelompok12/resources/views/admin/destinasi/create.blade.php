                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" value="{{ old('nama') }}"
                                        id="nama" placeholder="example: Danau Toba">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
                                <label for="tiket" class="col-sm-2 col-form-label">Harga Tiket</label>
                                <div class="col-sm-10">
                                    <input text="text" class="form-control" id="tiket" name="tiket"
                                        value="{{ old('tiket') }}" placeholder="example: 5k">
                                </div>
                            </div>
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <input text="text" class="form-control" id="lokasi" name="lokasi"
                                        value="{{ old('lokasi') }}" placeholder="example: Toba, Indonesia">
                                </div>
                            </div>

                            <div class="form-group row border-bottom pb-4">
                                <label for="destinasi_kategori" class="col-sm-2 col-form-label">Kategori Destinasi</label>
                                <div class="col-sm-10">
                                    <select class="form-control" id="destinasi_kategori" name="destinasi_kategori_id">
                                        <option value="">--Pilih--</option>
                                        @foreach($destinasiKategoris as $kategori)
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="7"
                                        placeholder="Description text...">{{ old('deskripsi') }}</textarea>
                                </div>
                            </div>
