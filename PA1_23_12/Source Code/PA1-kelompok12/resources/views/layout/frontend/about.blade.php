				...
				<div class="col-lg-9">
					<div class="row">
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="100">
							<div class="service-1">
								<span class="icon">
									<img src="{{ URL::asset('frontend/images/svg/01.svg')}}" alt="Image" class="img-fluid">
								</span>
								<div>
									<h3>Tourism</h3>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						...
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="200">
							<div class="service-1">
								<span class="icon">
									<img src="{{ URL::asset('frontend/images/svg/02.svg')}}" alt="Image" class="img-fluid">
								</span>
								<div>
									<h3>Package Tours</h3>
									<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						...
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="300">
							<div class="service-1">
								<span class="icon">
									<img src="{{ URL::asset('frontend/images/svg/03.svg')}}" alt="Image" class="img-fluid">
								</span>
								<div>
						...
						<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up"  data-aos-delay="400">
							<div class="service-1">
								<span class="icon">
									<img src="{{ URL::asset('frontend/images/svg/04.svg')}}" alt="Image" class="img-fluid">
								</span>
								<div>
	...
	<div class="section">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3">
					<a href="#" class="person">
						<img src="{{ URL::asset('frontend/images/person_1.jpg')}}" alt="Image" class="img-fluid mb-4">
				...
				<div class="col-lg-3">
					<a href="#" class="person">
						<img src="{{ URL::asset('frontend/images/person_2.jpg')}}" alt="Image" class="img-fluid mb-4">
						<span class="subheading d-inline-block">CEO, Co-Founder</span>
				...
				<div class="col-lg-3">
					<a href="#" class="person">
						<img src="{{ URL::asset('frontend/images/person_3.jpg')}}" alt="Image" class="img-fluid mb-4">
						<span class="subheading d-inline-block">CEO, Co-Founder</span>
