...
use App\Http\Requests\Contributor\BlogGalleryRequest;
use App\Http\Requests\Contributor\GalleryRequest;
...
class BlogGalleryController extends Controller
{
    ...
    {
        return view('contributor.blogGalleries.edit', compact('blog', 'gallery'));
    }
