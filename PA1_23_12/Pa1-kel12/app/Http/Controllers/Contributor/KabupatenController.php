...
class KabupatenController extends Controller
{
    ...
    {
        return view('contributor.kabupaten.create');
    }
    ...
    public function store(KabupatenRequest $request)
    {
        ...
        return redirect()->route('contributor.kabupaten.index')->with([
    ...
    {
        return view('contributor.kabupaten.edit', compact('kabupaten'));
    }
