		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<div class="hero overlay">
					<div class="rellax">
						<img src="{{ URL::asset('frontend/images/hero_1.jpg')}}" alt="Image" class="img-fluid animated">
					</div>
					<div class="container">
			...
			<div class="carousel-item">
				<div class="hero overlay">
					<div class="rellax">
						<img src="{{ URL::asset('frontend/images/hero_2.jpg')}}" alt="Image" class="img-fluid animated">
					</div>
					<div class="container">
						<div class="row align-items-center justify-content-start">
							<div class="col-lg-9 mx-auto text-center">
