	...
	<!-- Header Start -->
    <div class="container-fluid  mb-5" style="background-color: aquamarine">
		<div
	...
	<div class="container py-5">
		<div class="row pt-5">
		  <div class="col-lg-8">
			...
			<div class="mb-5">
			  <img
				...
				src="{{ URL::asset('frontend/images/hero_2.jpg')}}"
				alt="Image"
			  />
			  <p>
		  ...
		  <div class="col-lg-4 mt-5 mt-lg-0">
			...
			<!-- Single Image -->
			<div class="mb-5">
			  <img src="{{ URL::asset('frontend/images/hero_2.jpg')}}" alt="" class="img-fluid rounded" />
			</div>
