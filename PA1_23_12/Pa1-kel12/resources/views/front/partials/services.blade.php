            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-1">
                            <span class="icon">
                                <img src="{{ URL::asset('frontend/images/svg/01.svg') }}" alt="Image"
                                    class="img-fluid">
                            </span>
                            <div>
                                <h3>Tourism</h3>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-1">
                            <span class="icon">
                                <img src="{{ URL::asset('frontend/images/svg/02.svg') }}" alt="Image"
                                    class="img-fluid">
                            </span>
                            <div>
                                <h3>Package Tours</h3>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <div class="service-1">
                            <span class="icon">
                                <img src="{{ URL::asset('frontend/images/svg/03.svg') }}" alt="Image"
                                    class="img-fluid">
                            </span>
                            <div>
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-1">
                            <span class="icon">
                                <img src="{{ URL::asset('frontend/images/svg/04.svg') }}" alt="Image"
                                    class="img-fluid">
                            </span>
                            <div>
