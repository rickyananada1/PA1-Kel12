...
@section('subtitle')
    <a class="btn btn-warning" href="{{ Route('contributor.destination.index') }}" role="button" id="btn-batal"><i class="fa fa-arrow-left"></i>
        Kembali</a>
@endsection
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form class="d-inline-block"
                                                    action="{{ route('contributor.destination.gallery.destroy', [$destination, $gallery]) }}"
                ...
                <div class="col-lg-12">
                    <div class="card p-3">
                        <form method="post" action="{{ route('contributor.destination.gallery.store', [$destination]) }}"
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card p-3">
                                        <form method="post"
                                            action="{{ route('contributor.destination.update', [$destination->id]) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                            <div class="form-group row border-bottom pb-4">
