...
@section('subtitle')
    <a class="btn btn-warning" href="{{ Route('contributor.kabupaten.index') }}" role="button" id="btn-batal"><i class="fa fa-arrow-left"></i>
        Kembali</a>
@endsection
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card p-3">
                        <form method="POST" action="{{ route('contributor.kabupaten.store') }}" enctype="multipart/form-data">
                            @csrf
