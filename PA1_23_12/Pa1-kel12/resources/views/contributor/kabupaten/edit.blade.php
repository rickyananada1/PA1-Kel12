...
@section('subtitle')
    <a class="btn btn-warning" href="{{ Route('contributor.kabupaten.index') }}" role="button" id="btn-batal"><i
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card p-3">
                        <form method="post" action="{{ route('contributor.kabupaten.update', [$kabupaten->id]) }}"
